...
Who's playing matters too: if facts.player is present, thisMapVsUsualRange tells you whether this map is a reach, a curveball, or normal for this account. A reach means judge misses and low acc more gently, that's expected outside their comfort zone, not a real leak. A curveball played clean or FC'd is worth noting as an outlier result. Don't mention player rank or usual range unless thisMapVsUsualRange says it's not typical, a normal map for them needs no comment on who they are.
